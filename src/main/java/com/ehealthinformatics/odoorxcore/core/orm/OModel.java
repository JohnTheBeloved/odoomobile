...
import com.ehealthinformatics.odoorxcore.core.auth.OdooAccountManager;
...
import com.ehealthinformatics.odoorxcore.core.orm.annotation.Odoo;
...
import com.ehealthinformatics.odoorxcore.core.orm.fields.types.ODateTime;
import com.ehealthinformatics.odoorxcore.core.orm.fields.types.OInteger;
import com.ehealthinformatics.odoorxcore.core.orm.fields.types.OSelection;
import com.ehealthinformatics.odoorxcore.core.orm.provider.BaseModelProvider;
...
import com.ehealthinformatics.odoorxcore.core.service.ISyncServiceListener;
import com.ehealthinformatics.odoorxcore.core.service.OSyncAdapter;
import com.ehealthinformatics.odoorxcore.core.support.OUser;
import com.ehealthinformatics.odoorxcore.core.support.sync.SyncUtils;
import com.ehealthinformatics.odoorxcore.core.utils.OCursorUtils;
import com.ehealthinformatics.odoorxcore.core.utils.ODateUtils;
import com.ehealthinformatics.odoorxcore.core.utils.OListUtils;
import com.ehealthinformatics.odoorxcore.core.utils.OStorageUtils;
import com.ehealthinformatics.odoorxcore.core.utils.StringUtils;
...
public class OModel implements ISyncServiceListener {
    ...
    public static OModel get(Context context, String model_name, String username) {
        ...
        return DaoRepo.getInstance(context).getModel(context, model_name, user);
    }
    ...
    public void isInstalledOnServer(final String module_name, IModuleInstallListener callback) {
        DaoRepo daoRepo = DaoRepo.getInstance(mContext);
