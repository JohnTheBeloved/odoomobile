...
import com.ehealthinformatics.odoorxcore.core.service.SyncStatus
import com.ehealthinformatics.odoorxcore.core.utils.DateUtils
import com.ehealthinformatics.odoorxcore.data.db.Columns.SyncModel
import java.util.*
...
class SyncModel(var id: Int, var modelName: String, var authority: String,
                ...
                var status: String, var statusDetail: String, var lastSynced: Date, var parent: com.ehealthinformatics.odoorxcore.data.dto.SyncModel?,
                private var children: ArrayList<com.ehealthinformatics.odoorxcore.data.dto.SyncModel>, var pullToDeviceIds: Set<Integer>, var pushToServerIds: Set<Integer>) : DTO{
    ...
    fun addChild(syncModel: com.ehealthinformatics.odoorxcore.data.dto.SyncModel){
        children.add(syncModel)
    }

    fun getChildren(): Iterator<com.ehealthinformatics.odoorxcore.data.dto.SyncModel>{
