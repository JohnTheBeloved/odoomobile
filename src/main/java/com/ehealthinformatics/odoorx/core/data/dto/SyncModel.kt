...
import com.ehealthinformatics.odoorx.core.data.db.Columns.SyncModel
import java.util.*
...
class SyncModel(var id: Int, var modelName: String, var authority: String,
                ...
                var status: String, var statusDetail: String, var lastSynced: Date, var parent: com.ehealthinformatics.odoorx.core.data.dto.SyncModel?,
                private var children: ArrayList<com.ehealthinformatics.odoorx.core.data.dto.SyncModel>, var pullToDeviceIds: Set<Integer>, var pushToServerIds: Set<Integer>) : DTO{
    ...
    fun addChild(syncModel: com.ehealthinformatics.odoorx.core.data.dto.SyncModel){
        children.add(syncModel)
    }

    fun getChildren(): Iterator<com.ehealthinformatics.odoorx.core.data.dto.SyncModel>{
